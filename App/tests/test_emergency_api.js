...
describe('Emergency API Integration', () => {
  ...
  test('should trigger emergency alert', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      'http://192.168.1.4:8000/api/emergency/trigger',
      {
        method: 'POST',
        headers: {
  ...
  test('should confirm emergency alert', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      'http://192.168.1.4:8000/api/emergency/confirm',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  test('should cancel emergency alert', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      'http://192.168.1.4:8000/api/emergency/cancel',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  test('should get emergency status', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      'http://192.168.1.4:8000/api/emergency/status/test-alert-123'
    );
  ...
  test('should get emergency history', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      'http://192.168.1.4:8000/api/emergency/history?days=30&limit=50'
    );
