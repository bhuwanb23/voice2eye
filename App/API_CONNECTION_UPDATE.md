...
## Files Updated to Use Backend IP: 172.20.10.3:8000
...
const API_BASE_URL = __DEV__ 
  ? (typeof navigator !== 'undefined' && navigator.product === 'ReactNative')
    ? 'http://172.20.10.3:8000/api'  // Your PC's IP for Android/mobile
    : 'http://172.20.10.3:8000/api'  // Your PC's IP for web
  : 'https://your-production-domain.com/api';  // Production URL
```
...
```javascript
const BACKEND_URL = 'http://172.20.10.3:8000/api/gestures/detect';
```
...
All API connections will now point to: **http://172.20.10.3:8000**
