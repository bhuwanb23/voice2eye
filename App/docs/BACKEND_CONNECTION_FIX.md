...
### Main Health Check
```
GET http://192.168.1.5:8000/api/health
```
**Response:**
```json
{
...
```
GET http://192.168.1.5:8000/api/health/speech
GET http://192.168.1.5:8000/api/health/gestures
GET http://192.168.1.5:8000/api/health/emergency
GET http://192.168.1.5:8000/api/health/storage
```

### API Root
```
GET http://192.168.1.5:8000/api/
```
**Response:**
```json
{
...
```
LOG  API Request: GET http://192.168.1.5:8000/api/...
```
...
Access the API at: http://192.168.1.5:8000
Health check: http://192.168.1.5:8000/api/health
```
...
- Test: `ping 192.168.1.5` from phone (use network analyzer app)
...
- ✅ `App/api/services/apiService.js` → Uses `http://192.168.1.5:8000/api`
- ✅ `App/hooks/useGestureDetector.js` → Uses `http://192.168.1.5:8000/api/gestures/detect`
...
2. ✅ **Verify Backend is Listening:**
   ...
   - Open browser: `http://192.168.1.5:8000/api/health`
   - Should return: `{"status": "healthy", ...}`

3. ✅ **Test Mobile Connection:**
   - On your phone's browser: `http://192.168.1.5:8000/api/health`
