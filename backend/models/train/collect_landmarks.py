...
# ✏️ EDIT THIS LIST — add your own gesture names
GESTURES = ["thumbs_up", "peace", "fist", "open_hand"]

def collect(label: str, output_csv: str = "dataset.csv"):
...
if __name__ == "__main__":
    for gesture in GESTURES:
        ...
        print("Aim to collect at least 50 samples per gesture.")
        collect(gesture)
    print("\nDone! dataset.csv is ready.")